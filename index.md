...
<script>
    const bfacts = [
        ...
        "Brandon loves Dreamwork's Madagascar but doesn't even know the name of the zebra.",
        ...
        "Brandon only knows the dry cereal guy who lives on Drury Lane.",
        ...
        "Brandon has gotten perfect scores on breathalyzer tests.",
